...
const OKLID = {
  ...
  nesneler: [
    ...
    yayDilim('capYayi', 'yay', 'O', 'B', 'A', 4, { rol: 'notr', kalinlik: 1, opaklik: 0 }),
    surgu('C', 'capYayi', 0, 5, 5, { rol: 'seftali', etiket: 'C' }),
    cokgen('ucgen', ['A', 'B', 'C'], 6, { rol: 'nane', opaklik: 0.3 }),
    aci('dikAci', 'A', 'C', 'B', 7, { rol: 'tereyagi' }),
    izdusum('H', 'C', 'hipotenus', 8, { rol: 'gok', etiket: 'H' }),
    cizgi('yukseklik', 'dogru_parcasi', 'C', 'H', 9, { rol: 'gok', kalinlik: 3 }),
    uzunluk('p', 'A', 'H', 10, { rol: 'lavanta', etiket: 'AH' }),
    uzunluk('k', 'H', 'B', 11, { rol: 'gul', etiket: 'HB' }),
    uzunluk('h', 'C', 'H', 12, { rol: 'gok', etiket: 'CH' }),
    uzunluk('b', 'A', 'C', 13, { rol: 'seftali', etiket: 'AC' }),
    uzunluk('a', 'C', 'B', 14, { rol: 'tereyagi', etiket: 'CB' }),
  ],
  adimlar: [
